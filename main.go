...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:12100", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "zero-小恶魔", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "小恶魔", "ai"),
